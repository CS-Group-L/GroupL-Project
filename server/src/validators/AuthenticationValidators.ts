...
const usernameCreateSchema = usernameSchema
    .isLength({ min: 8 }).withMessage("A username must at least have a length of 8 characters");
...
const passwordRegisterSchema = passwordSchema
    .isStrongPassword()
    .withMessage("Password must at least have a length of 8, 1 lowercase letter, 1 uppercase letter, 1 number and 1 symbol");
